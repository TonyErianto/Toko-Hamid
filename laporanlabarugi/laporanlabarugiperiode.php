...
<head>
    ...
    <title>Laporan Laba Rugi Periode - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<body>                     
                    ...
                    <div class="header-layout">
                        <div class="filter-layout">
                            ...
                            <input type="submit" name="labarugiperiode" value="Filter">
                            </form>
                        </div>
                    <div class="button-exit-layout">
                        <a href="../laporanlabarugi/cetaklaporanlabarugiperiode.php?tanggalawal=<?php echo "$tanggalawal" ?>&tanggalakhir=<?php echo "$tanggalakhir"?>&labarugiperiode=true">Cetak</a>
