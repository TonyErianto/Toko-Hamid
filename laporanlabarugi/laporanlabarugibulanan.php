...
<head>
    ...
    <title>Laporan Laba Rugi Bulanan - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<?php
                    ...
                    <div class="header-layout">
                        ...
                        <form action="" method="GET">
                            <input type="month" value="<?php echo $bulanini ?>" name="bulan">
                            <input type="submit" name="bulanini" value="Filter">
                         </form>
                        </div>
                    <div class="button-exit-layout">
                        <a href="../laporanlabarugi/cetaklaporanlabarugibulanan.php?bulan=<?php echo $bulanini ?>">Cetak</a>
                    ...
                    <p>Laporan Laba Rugi Bulanan</p>
                    <p>Bulan : <?php echo "$bulanini"?> </p>
                    <br>
                    <hr>
                    <br>
                     </center>
