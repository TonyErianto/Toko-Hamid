...
<head>
    ...
    <title>Laporan Laba Rugi Periode - Tanggal : <?php echo date('d-m-Y', strtotime($_GET["tanggalawal"]))?> s/d Tanggal : <?php echo date('d-m-Y', strtotime($_GET["tanggalakhir"])) ?> - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<body>                     
                    ...
                    <p style="text-align:center">Laporan Laba Rugi Periode</p>
                    <p style="text-align:center">Periode - Tanggal : <?php echo date('d-m-Y', strtotime($_GET["tanggalawal"]))?> s/d Tanggal : <?php echo date('d-m-Y', strtotime($_GET["tanggalakhir"])) ?></p>
                    <br>
                    <hr>
                    <br>
                     <?php
                        ...
                        $totalmodaljual="SELECT SUM(total_harga_barang_modal) AS totalmodal, SUM(total_harga_barang_jual) AS totaljual FROM tb_penjualan  WHERE tanggal_transaksi BETWEEN '$tanggalawal' AND '$tanggalakhir' ORDER BY tanggal_transaksi ASC"; 
...
<?php
$filename="Laporan Laba Rugi Periode -  Tanggal ".date('d-m-Y', strtotime($_GET["tanggalawal"]))." - Tanggal ".date('d-m-Y', strtotime($_GET["tanggalakhir"])).".pdf";
