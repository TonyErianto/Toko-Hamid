...
<head>
    ...
    <title>Laporan Laba Rugi Tahun <?php echo $_GET["tahunini"] ?> - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<body>              
                    ...
                    <p style="text-align:center">Laporan Laba Rugi Tahunan</p>
                    ...
                    <hr>
                     <?php
                        ...
                        $totalinternet = "SELECT SUM(harga_beban) AS hargainternet FROM tb_data_beban WHERE tanggal_transaksi LIKE '%$tahunini%'";
...
<?php
$filename="Laporan Laba Rugi - Tahun ".$_GET["tahunini"].".pdf";
