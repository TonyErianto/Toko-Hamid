...
<head>
    ...
    <title>Laporan Pendapatan Periode  - Tanggal : <?php echo date('d-m-Y', strtotime($_GET["tanggalawal"]))?> s/d Tanggal : <?php echo date('d-m-Y', strtotime($_GET["tanggalakhir"])) ?> -  - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<body>
                    ...
                    <p style="text-align:center">Laporan Pendapatan Periode</p>
