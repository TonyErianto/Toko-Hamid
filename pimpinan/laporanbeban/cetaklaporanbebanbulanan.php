...
<head>
    ...
    <title>Laporan Beban Bulan <?php echo  date('M-Y', strtotime($_GET["bulanini"])) ?> - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<body>   
                    ...
                    <p style="text-align:center">Laporan Beban Bulanan</p>
                    <p style="text-align:center">Bulan : <?php echo  date('M-Y', strtotime($_GET["bulanini"])) ?></p>
                    <hr>
                     <?php
                        $bulanini = $_GET["bulanini"];
...
<?php
$filename="Laporan Beban - Bulan ".$_GET["bulanini"].".pdf";
