...
<head>
    ...
    <title>Laporan Pendapatan Bulan <?php echo  date('M-Y', strtotime($_GET["bulanini"])) ?> - Toko Hamid Furniture Padang</title>
</head>
<style>
   hr{
...
<body>
                    ...
                    <p style="text-align:center">Laporan Pendapatan Bulanan</p>
                    ...
                    <?php
                        ...
                        $no=1;
                        $data="SELECT * FROM tb_penjualan WHERE tanggal_transaksi LIKE'%$bulanini%' ORDER BY tanggal_transaksi ASC  ";
                        $total="SELECT SUM(total_harga_barang_modal) AS totalmodal, SUM(total_harga_barang_jual) AS totaljual FROM tb_penjualan  WHERE tanggal_transaksi LIKE'%$bulanini%' ORDER BY tanggal_transaksi ASC"; 
...
<?php
$filename="Laporan Pendapatan - Bulan ".$_GET["bulanini"].".pdf";
