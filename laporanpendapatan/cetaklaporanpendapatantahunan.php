...
<head>
    ...
    <title>Laporan Pendapatan Tahun <?php echo  $_GET["tahunini"] ?> - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<body>
                    ...
                    <p style="text-align:center">Laporan Pendapatan Tahunan</p>
                    <p style="text-align:center">Tahun : <?php echo $_GET["tahunini"] ?></p>
                    <hr>
                    <table>
                        <tr>
                            <th>No</th>
                    ...
                    $no=1;
                    $data="SELECT * FROM tb_penjualan WHERE tanggal_transaksi LIKE'%$tahunini%' ORDER BY tanggal_transaksi ASC  ";
                    $total="SELECT SUM(total_harga_barang_modal) AS totalmodal, SUM(total_harga_barang_jual) AS totaljual FROM tb_penjualan  WHERE tanggal_transaksi LIKE'%$tahunini%' ORDER BY tanggal_transaksi ASC"; 
...
<?php
$filename="Laporan Pendapatan - Tahun ".$_GET["tahunini"].".pdf";
