...
<head>
    ...
    <title>Laporan Beban Tahunan - Toko Hamid Furniture Padang</title>
</head>
<style>
    hr{
...
<?php
                    ...
                    <div class="header-layout">
                        ...
                        <div class="button-exit-layout">
                            <a href="../laporanbeban/cetaklaporanbebanpertahun.php?tahunini=<?php echo"$tahunini"?>">Cetak</a>
                    ...
                    <?php
                     if(isset($_GET["tahunini"])){
                        $tahunini=$_GET['tahun'];
                        $databeban  = "SELECT * FROM tb_data_beban WHERE tanggal_transaksi LIKE '%$tahunini%' ORDER BY tanggal_transaksi ASC";
