...
<body>   
                    ...
                    <p>Bulan : <?php echo date('F-Y', strtotime($bulanini))?></p>
                    <br>
                    <hr>
                    <br>
                     </center>
                     ...
                     if(isset($_GET["bulanini"])){
                        $bulanini = $_GET["bulan"];
                        $databeban  = "SELECT * FROM tb_data_beban WHERE tanggal_transaksi LIKE '%$bulanini%' ORDER BY tanggal_transaksi ASC";
